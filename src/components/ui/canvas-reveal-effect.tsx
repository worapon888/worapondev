...
// ==========================
// CanvasRevealEffect (public component)
// ==========================
...
const ShaderMaterial = ({ source, uniforms, maxFps = 60 }: ShaderProps) => {
  ...
  const getUniforms = (): PreparedUniforms => {
    ...
    for (const name in uniforms) {
      ...
      switch (type) {
        case "uniform1f":
          prepared[name] = { value: value as number, type: "1f" };
          break;
        case "uniform1fv":
          prepared[name] = { value: value as number[], type: "1fv" };
          break;
        case "uniform2f":
          prepared[name] = {
        ...
        case "uniform3fv":
          ...
          break;
        default:
          console.warn(`Unhandled uniform type: ${type}`);
          break;
      }
    }
